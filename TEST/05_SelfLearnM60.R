...
file.copy(from = file.path(path_model, "LOG", "AI_T-60.csv"), 
          to = c("C:/Program Files (x86)/ICMarkets MT4 Terminal2/MQL4/Files/AI_T-60.csv",
                 "C:/Program Files (x86)/ICMarkets MT4 Terminal1/MQL4/Files/AI_T-60.csv",
                 "C:/Program Files (x86)/ICMarkets MT4 Terminal3/MQL4/Files/AI_T-60.csv",
                 "C:/Program Files (x86)/ICMarkets MT4 Terminal4/MQL4/Files/AI_T-60.csv",
                 "C:/Program Files (x86)/ICMarkets MT4 Terminal5/MQL4/Files/AI_T-60.csv"),
          overwrite = TRUE) 
#### End